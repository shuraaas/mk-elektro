  ...
  return (
    <>
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal}>
        <h2>Конкурс "Удар Молнии"</h2>
        <p>
          1. Участниками являются покупатели с чеками, приобретавшими продукцию
          MILWAUKEE, на сумму от 5000р в период с 1 июля по 13 августа
          включительно.
        </p>
        <p>2. Призы вручаются за самое быстрое время выполнения задания.</p>
        <div>
          <p>3. Задание на конкурс:</p>
          <ul>
            <li>
              - Запустить таймер, разобрать молнию гайковертом. Все сделать
              одной рукой.
            </li>
            <li>
              - Собрать молнию (надежно закрепить болты), остановить таймер.
            </li>
          </ul>
        </div>
        <div>
          <p>4. Призы:</p>
          <ul>
            <li>- 1 место - Гайковерт MILWAUKEE</li>
            <li>- 2 место - УШМ MILWAUKEE проводная</li>
            <li>- 3 место - Рюкзак MILWAUKEE</li>
          </ul>
        </div>
        <p>5. Результаты будут подведены в конце фестиваля.</p>
      </Modal>
    </>
  );
};
